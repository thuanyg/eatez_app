...
public class PostHomeAdapter extends RecyclerView.Adapter<PostHomeAdapter.MyViewHolder> {
    ...
    public PostHomeAdapter(Context context, List<Post> postList, MyClickItemListener<Post> listener) {
