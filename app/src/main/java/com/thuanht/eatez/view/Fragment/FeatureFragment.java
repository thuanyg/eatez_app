            ...
            public void run() {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        adapter = new PostFeatureAdapter(list);
...
//        Toast.makeText(requireContext(), "Resume", Toast.LENGTH_SHORT).show();
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        // Lưu trạng thái của fragment vào Bundle
        outState.putBoolean("isFeatureFragmentInitialized", true);
    }
    ...
    public List<Post> fetchData(){
        ...
        ls.add(new Post("Bánh flan trứng gà - Quán Bánh Flan Bà Lành", "Bánh flan trứng gà mềm mịn, hương vani thơm ngon."));
        ls.add(new Post("Bánh mì kẹp thịt - Quán Bánh Mì Kẹp Bà Hà", "Bánh mì kẹp thịt giòn, nhân thịt ngọt ngào, ăn kèm rau sống."));
        ls.add(new Post("Cháo gà - Quán Cháo Gà Ông Địa", "Cháo gà mềm, thơm ngon, ăn kèm hành phi và tiêu."));
        ls.add(new Post("Bún thang - Quán Bún Thang Ông Dương", "Bún thang đặc trưng với nước dùng thơm ngon, gà, trứng và nấm."));
        ls.add(new Post("Nước ép trái cây - Quán Nước Ép Trái Cây Ba Dũng", "Nước ép trái cây tươi mát, đa dạng với các loại trái cây."));
        ls.add(new Post("Bánh tráng trộn - Quán Bánh Tráng Trộn Bà Mười", "Bánh tráng trộn cay nồng, vị chua ngọt, hòa quyện cùng các loại gia vị."));
        ls.add(new Post("Bò lúc lắc - Quán Bò Lúc Lắc 8 Chân", "Bò lúc lắc thơm ngon, giòn tan, ăn kèm cơm trắng."));
        ls.add(new Post("Bánh flan trứng gà - Quán Bánh Flan Bà Lành", "Bánh flan trứng gà mềm mịn, hương vani thơm ngon."));
        ls.add(new Post("Bánh mì kẹp thịt - Quán Bánh Mì Kẹp Bà Hà", "Bánh mì kẹp thịt giòn, nhân thịt ngọt ngào, ăn kèm rau sống."));
        ls.add(new Post("Cháo gà - Quán Cháo Gà Ông Địa", "Cháo gà mềm, thơm ngon, ăn kèm hành phi và tiêu."));
        ls.add(new Post("Bún thang - Quán Bún Thang Ông Dương", "Bún thang đặc trưng với nước dùng thơm ngon, gà, trứng và nấm."));
        ls.add(new Post("Nước ép trái cây - Quán Nước Ép Trái Cây Ba Dũng", "Nước ép trái cây tươi mát, đa dạng với các loại trái cây."));
        ls.add(new Post("Bánh tráng trộn - Quán Bánh Tráng Trộn Bà Mười", "Bánh tráng trộn cay nồng, vị chua ngọt, hòa quyện cùng các loại gia vị."));
        ls.add(new Post("Bò lúc lắc - Quán Bò Lúc Lắc 8 Chân", "Bò lúc lắc thơm ngon, giòn tan, ăn kèm cơm trắng."));ls.add(new Post("Bánh flan trứng gà - Quán Bánh Flan Bà Lành", "Bánh flan trứng gà mềm mịn, hương vani thơm ngon."));
        ls.add(new Post("Bánh mì kẹp thịt - Quán Bánh Mì Kẹp Bà Hà", "Bánh mì kẹp thịt giòn, nhân thịt ngọt ngào, ăn kèm rau sống."));
        ls.add(new Post("Cháo gà - Quán Cháo Gà Ông Địa", "Cháo gà mềm, thơm ngon, ăn kèm hành phi và tiêu."));
        ls.add(new Post("Bún thang - Quán Bún Thang Ông Dương", "Bún thang đặc trưng với nước dùng thơm ngon, gà, trứng và nấm."));
        ls.add(new Post("Nước ép trái cây - Quán Nước Ép Trái Cây Ba Dũng", "Nước ép trái cây tươi mát, đa dạng với các loại trái cây."));
        ...
        ls.add(new Post("Bánh tráng trộn - Quán Bánh Tráng Trộn Bà Mười", "Bánh tráng trộn cay nồng, vị chua ngọt, hòa quyện cùng các loại gia vị."));
        ls.add(new Post("Bò lúc lắc - Quán Bò Lúc Lắc 8 Chân", "Bò lúc lắc thơm ngon, giòn tan, ăn kèm cơm trắng."));
        ls.add(new Post("Bánh bèo - Quán Bánh Bèo 9 Góc Tính", "Bánh bèo nhỏ xinh, nước mắm chấm đậm đà, chà bông thơm."));
        ls.add(new Post("Bánh flan trứng gà - Quán Bánh Flan Bà Lành", "Bánh flan trứng gà mềm mịn, hương vani thơm ngon."));
        ls.add(new Post("Bánh mì kẹp thịt - Quán Bánh Mì Kẹp Bà Hà", "Bánh mì kẹp thịt giòn, nhân thịt ngọt ngào, ăn kèm rau sống."));
        ls.add(new Post("Cháo gà - Quán Cháo Gà Ông Địa", "Cháo gà mềm, thơm ngon, ăn kèm hành phi và tiêu."));
        ls.add(new Post("Bún thang - Quán Bún Thang Ông Dương", "Bún thang đặc trưng với nước dùng thơm ngon, gà, trứng và nấm."));
    ...
    public void applyChanges(List<Post> list) {
        if (adapter != null) {
            // Cập nhật dữ liệu trên adapter
            adapter.setData(list);
            adapter.notifyDataSetChanged();
        } else {
            // Xử lý trường hợp adapter chưa được khởi tạo hoặc gán vào RecyclerView
        }
    }

    public ShimmerFrameLayout getShimmerFrameLayout() {
        return binding.shimmerHome;
    }
